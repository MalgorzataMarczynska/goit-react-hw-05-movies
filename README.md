# An application to display the latest movies and find your own titles based on public REST API with additional information about the cast of the movie and reviews using React functional components.
